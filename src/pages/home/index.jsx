...
import HomeCard from "../../share/home-card";
...
const Home = () => {
    ...
    const { handleTheme, check, menuItemTwo, NavLink, selectedTab, setSelectedTab } = UseData();
    const handle = (e) => {
        handleTheme(e);
    };
            ...
            <section className="bg-homeBg dark:bg-homeTwoBg-dark min-h-screen  bg-no-repeat bg-center bg-cover bg-fixed  md:pb-16 w-full">
                        ...
                        {menuItemTwo.map((item) =>
                            <li onClick={() => {
                                ...
                                <span
                                    ...
                                    className={cn(menuOpen ? 'pl-4' : 'mx-2.5 rounded-md',
                                        ...
                                        selectedTab === "/homeTwo" && item.id === "01" ? 'dark:text-[#FA5252] text-[#FA5252]' : '',
                                        selectedTab === item?.link ? 'text-[#FA5252]  hover:text-[#FA5252]' : 'dark:text-white dark:hover:text-[#FA5252]  hover:text-[#FA5252]'
                                    )}>
                ...
                <div className="container grid grid-cols-12 md:gap-10    justify-between lg:mt-[220px] ">
                    ...
                    <div className="col-span-12 lg:col-span-8  ">
                        ...
                        {selectedTab === '/homeTwo/about' && <About />}
                        {selectedTab === '/homeTwo/resume' && <Resume />}
                        {selectedTab === '/homeTwo/works' && <Portfilo />}
                        {selectedTab === '/homeTwo/blogs' && <Blog />}
                        {selectedTab === '/homeTwo/contact' && <Contact />}
